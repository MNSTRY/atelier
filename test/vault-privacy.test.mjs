...
const context = { vault: 'sample-vault', publication: 'example-digest', phase: 'read', deployment, manifest: [{path: 'report.html', sha256: '1'.repeat(64)}], objects: [{key: 'sample-vault/object', sha256: '1'.repeat(64), size: 4}], owner: { issuer: 'https://identity.example', subject: 'synthetic-author' } }
