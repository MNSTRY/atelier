...
@media print { [data-ap-root] { --ap-color-text:#000;--ap-color-page:#fff;--ap-color-panel:#fff;--ap-color-muted:#333;--ap-color-selected:#fff;--ap-color-accent:#000;--ap-color-danger:#000;--ap-color-success:#000; color:#000;background:#fff;padding:0; } [data-ap-root] :is(.ap-nav,.ap-resize,button,dialog) { display:none !important; } [data-ap-root] .ap-workspace { display:block; } [data-ap-root] .ap-pane { border:0;break-inside:auto; } [data-ap-root] a { color:#000; } }
`
